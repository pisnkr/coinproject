...
# GCS settings
GOOGLE_CLOUD_STORAGE_BUCKET = 'koala_joa'  # GCS 버킷 이름
...
CHANNEL_LAYERS = {
    "default": {
        "BACKEND": "channels_redis.core.RedisChannelLayer",
        "CONFIG": {
            "hosts": [("redis", 6379)],  # 서비스 이름과 포트 번호 수정
        },
    },
}
...
# ]
# collectstatic 명령을 사용하여 정적 파일을 모을 디렉토리 설정
# STATIC_ROOT = os.path.join(BASE_DIR, 'static')  # 또는 원하는 다른 경로로 설정
